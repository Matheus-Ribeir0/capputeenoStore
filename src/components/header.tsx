  ...
  return (
    <div>
         <div className="flex justify-center items-center h-20  text-black bg-white ">
          <div className='h-full w-[1200px] flex justify-between items-center ph-20'>

            <h1 className='font-saira-stencil text-4xl p-4 text-black text-gray-500'>capputeeno</h1>
            ...
            <div className='flex justify-center items-center  p-4'>
              ...
              <button className="relative w-[40px] h-[40px] mx-3">
                <img src={storeIcon} className="w-[25px] " />
                <span className="absolute bottom-[1px] right-[10px] w-4 h-4 bg-red-500 rounded-full flex items-center justify-center text-white text-xs">
                  {shopQtd}
                </span>
              </button>
